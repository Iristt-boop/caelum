...
// "nox" 是他现在用的作者名 —— Nox Core 的 reading_reply_note 就是这么写的
// （nox-core/tools/reading.py:118），线上已经有这类回复。
// 漏了它会出实际的错：下面 momentFromAnnotations 的 leftLabel 会把他的回复
// 标成 "You"，卡片上等于把他说的话算到糖糖头上。
// "claude" / "assistant" / 空 都留着 —— 老数据里有。
