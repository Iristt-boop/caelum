...
// ───────────── 配置（改成你自己的）─────────────
const char* WIFI_SSID = "REDACTED-WIFI-SSID";       // WiFi 名
const char* WIFI_PASS = "REDACTED-WIFI-PASS";  // WiFi 密码
const char* VPS_URL   = "http://43.133.211.140:9333/touch";  // touch-server 端口
// ─────────────────────────────────────────────
